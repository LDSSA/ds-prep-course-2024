...
from minesweeper_game_project.minesweeper_game.constants import Square
...
@pytest.fixture
def mines():
    with patch('minesweeper_game_project.minesweeper_game.mines.MinesweeperGame.generate_mines', return_value=TESTING_GRID):
