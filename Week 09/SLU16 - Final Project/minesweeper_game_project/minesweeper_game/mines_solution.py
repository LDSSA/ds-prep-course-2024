"""
This is the module containing the MinesweeperGame class.
It's basically the class that has the state and the 'movements' of the game.
It is on you to complete the class methods.
...
Here are a few hints:
    1. Start by reading the docstring to understand what should the method do.
    2. Check if you can call other methods to help you with the implementation.
    3. You can use the `print` function to debug your code. The output will show in the terminal.
"""

from typing import List, Tuple
import random

from minesweeper_game_project.minesweeper_game.constants import Square, SQUARE_CORRESPONDENCE
...
class MinesweeperGame:
    ...
    :attr mines: The positions of the mines
